...
We evaluate the performance of the model with different context lengths, to see how it affects top-1 and top-3 accuracies.
Results are shown in the Fig. \ref{fig:baseline}.
