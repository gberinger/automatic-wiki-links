...
Next step is to check the influence of alpha parameter on the accuracy score after one epoch of training with fixed context length - the best value for the base model. Results are shown in Figure \ref{fig:exp2_alpha}. In this experiment we also mark the measurement uncertainty on the graph.
