...
\end{figure}
Independent of some noise caused by random order of training data, the optimized model is much better than the base model. Interestingly, the improvement is most visible for long context lengths, which achieved relatively poor results in the baseline experiment.
