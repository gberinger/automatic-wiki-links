...
Due to high impact of training data order on test results, as a result we take average score of 30 runs for each optimization with random order of training data. The best configuration of each experiment is taken as a baseline for the next experiment.
